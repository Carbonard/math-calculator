...
//					 E_SPACE,	E_NUMBER,			E_OPEN_PAR,			E_CLOS_PAR,				E_SIGN,				E_OPERATOR,			E_SING_OP,			E_OTHER
	[S_INITIAL]	= {SE_SUCCESS, SE_SUCCESS,			SE_SUCCESS,			SE_CLOS_PAR,SE_SUCCESS,			SE_EMPTY_OP,	SE_SUCCESS,			SE_UNDEFINED},
	[S_NUMBER]	= {SE_SUCCESS, SE_SPACE,		SE_MISSING_OP,SE_SUCCESS,				SE_SUCCESS,			SE_SUCCESS,			SE_MISSING_OP,SE_UNDEFINED},
	[S_OPERATOR]= {SE_SUCCESS, SE_SUCCESS,			SE_SUCCESS,			SE_EMPTY_OP,		SE_SUCCESS,			SE_EMPTY_OP,	SE_SUCCESS,			SE_UNDEFINED},
	[S_OPEN_PAR]= {SE_SUCCESS, SE_SUCCESS,			SE_SUCCESS,			SE_SUCCESS,				SE_SUCCESS,			SE_EMPTY_OP,	SE_SUCCESS,			SE_UNDEFINED},
	[S_CLOS_PAR]= {SE_SUCCESS, SE_MISSING_OP, SE_MISSING_OP,SE_SUCCESS,				SE_SUCCESS,			SE_SUCCESS,			SE_MISSING_OP,SE_UNDEFINED},
	[S_SIGN]	= {SE_SUCCESS, SE_SUCCESS,			SE_SUCCESS,			SE_EMPTY_OP,		SE_EMPTY_OP,	SE_EMPTY_OP,	SE_SUCCESS,			S_ERROR},
	// [S_ERROR] =		{, , , , , , }
};
